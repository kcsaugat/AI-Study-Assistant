  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-24 right-6 z-40 w-14 h-14 rounded-full bg-gradient-to-r from-[#10b981] to-[#0ea5e9] flex items-center justify-center text-white shadow-[0_0_20px_rgba(14,165,233,0.5)] hover:shadow-[0_0_30px_rgba(16,185,129,0.8)]"
